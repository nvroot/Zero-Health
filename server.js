...
app.post('/api/auth/forgot-password', async (req, res) => {
    try {
        ...
        const recoveryUrl = `http://nc5.netbird.selfhosted:6001/reset-password?email=${encodeURIComponent(email)}&code=${recoveryCode}`;
...
app.get('/reset-password', (req, res) => {
    ...
    res.redirect(`http://nc5.netbird.selfhosted:6001/reset-password?${req.url.split('?')[1] || ''}`);
});
*/
