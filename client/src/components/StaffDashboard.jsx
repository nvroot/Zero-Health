...
const StaffDashboard = () => {
  ...
  const fetchPatients = async () => {
    try {
      const response = await fetch('http://nc5.netbird.local:6002/api/patients', {
  ...
  const fetchUsers = async () => {
    try {
      const response = await fetch('http://nc5.netbird.local:6002/api/admin/users', {
        headers: getAuthHeaders()
      });
      if (response.ok) {
        const data = await response.json();
  ...
  const fetchStatistics = async () => {
    try {
      const response = await fetch('http://nc5.netbird.local:6002/api/admin/statistics', {
        headers: getAuthHeaders()
      });
      if (response.ok) {
        const data = await response.json();
  ...
  const handleCollectPrescription = async (prescriptionId) => {
    try {
      const response = await fetch(`http://nc5.netbird.local:6002/api/prescriptions/${prescriptionId}/collect`, {
        method: 'PUT',
        headers: getAuthHeaders()
      });
  ...
  const handleDeleteUser = async (userId) => {
    ...
    try {
      const response = await fetch(`http://nc5.netbird.local:6002/api/admin/users/${userId}`, {
        method: 'DELETE',
        headers: getAuthHeaders()
      });
  ...
  const handleUpdateUserRole = async (userId, newRole) => {
    try {
      const response = await fetch(`http://nc5.netbird.local:6002/api/admin/users/${userId}/role`, {
        method: 'PUT',
        headers: getAuthHeaders(),
